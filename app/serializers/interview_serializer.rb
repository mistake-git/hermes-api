class InterviewSerializer < ActiveModel::Serializer
  attributes :id, :name, :interview_time_from, :interview_time_to, :formatted_interview_time_from, :formatted_interview_time_to, :interview_type, :interview_url, :interview_address, :status, :interview_items_attributes
